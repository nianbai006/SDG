#!/usr/bin/env python3
"""
Translate human annotations with Gemini and generate think reasoning.
...
6) <answer> MUST be a JSON list in xyxy format:
   [{{"box_2d":[x0,y0,x1,y1],"label":"artifact"|"misalignment","description":"..."}}, ...]
...
<answer>
[
  {{"box_2d":[777,604,796,627],"label":"artifact","description":"On the image-right hand near the fingertips, the ring appears fused into the finger, evidenced by a smeared metal-to-skin boundary at the contact interface where the outline should be clean and separated."}},
  {{"box_2d":[759,640,778,665],"label":"artifact","description":"On the image-right hand around the mid-finger ring edge, the metal outline blends into skin, forming a compact localized fusion with ssoftened borders and continuous texture where a sharp ring boundary is expected."}},
  {{"box_2d":[760,671,776,686],"label":"artifact","description":"Just below the rings on the image-right fingers, a small patch    of skin shows unnatural raised bumps and inconsistent shading, forming a tiny localized texture anomaly rather than coherent wrinkles or pores."}},
  {{"box_2d":[212,641,242,713],"label":"artifact","description":"On the image-left hand holding the sign, the ring looks partially embedded into the finger, with distorted geometry and a boundary that appears to cross from glossy metal into flesh without a clear separation."}},
  {{"box_2d":[417,144,563,370],"label":"misalignment","description":"The face in the upper-central area does not satisfy the caption’s identity requirement, since key facial proportions and styling do not resemble Jim Morrison and instead read as a generic rock musician."}},
  {{"box_2d":[267,493,734,813],"label":"misalignment","description":"The sign’s central text block does not match the required phrase “hail Satan”, as the letters are misspelled and deformed, producing unreadable character shapes rather than a clear, correctly spelled sentence."}}
]
</answer>
